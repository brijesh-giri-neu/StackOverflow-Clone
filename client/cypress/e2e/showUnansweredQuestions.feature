...
Feature: Show unanswered questions
  ...
  Scenario: Show all unanswered questions
    Given The user can access the homepage to view unanswered "http://localhost:3000"
  ...
  Scenario Outline: Return to Unanswered tab after viewing other question orders
    Given The user is viewing questions to view unanswered in "<currentOrder>"
  ...
  Scenario: View unanswered questions after answering an existing question
    Given The user is viewing the homepage to view unanswered "http://localhost:3000"
